...
//this file was renamed because with the original name 'EarlGrey' the EarlGrey pod couldn't be used as dependency in our podspec
//after pod update the original file will be re-created - you have to delete this file and rename the new one (note: also the class name was renamed from EarlGrey -> MatchaEarlGrey - but the compiler will tell you anyway)
...
public func GREYFail(_ reason: String) {
  MatchaEarlGrey.handle(exception: GREYFrameworkException(name: kGREYAssertionFailedException,
                                                    reason: reason),
                  details: "")
}
...
open class MatchaEarlGrey: NSObject {
